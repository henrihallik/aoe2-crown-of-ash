...
[Download Crown of Ash v1.0.0](https://github.com/henrihallik/aoe2-crown-of-ash/releases/download/v1.0.0/Crown-of-Ash-v1.0.0.zip)
...
indestructible, and grants **24 gold per minute** while held. Its rich mines and
five relics are guarded by hostile neutral predators. Four unconnected side
clearings contain randomized resource caches, rewarding scouting and deliberate
forest cutting. In team games, allies also receive narrow rear roads.
...
[`dist/Crown-of-Ash-v1.0.0.zip`](./dist/Crown-of-Ash-v1.0.0.zip) inside it.
...
- `guard_state` for the Crown's live gold income
